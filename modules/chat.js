...
function renderChatMessages() {
  ...
  if (chatHistory.length === 0) {
    dom.chatMessages.innerHTML = `<div style="color:#8e8e93;text-align:center;padding:40px 0;font-size:16px;">开始新的对话吧 💬</div>`;
    return;
  }
  let html = '';
